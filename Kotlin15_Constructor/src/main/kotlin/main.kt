...
// 생성자를 작성하게 되면 매개변수가 없고 코드가 작성되어 있지 않은 생성자가 자동으로 추가되지 않는다.
...
class TestClass4{
    ...
    constructor(memberA1:Int, memberA2:Int){
        ...
        // 생성자나 메서드의 매개변수 이름과 맴버 변수의 이름이 같은 경우 맴버 변수를 사용하고자 한다면 this를 사용한다.
...
// 주 생성자 사용
// constructor 에 명시한 변수들은 맴버 변수로 정의가 되고 매개 변수 3개를 가지고 있는 생성자가 자동으로 추가된다.
